            ...
            <div className={` ${hamActive ? 'w-[75%] max-sm:w-full' : 'w-full'} flex vh-100`}>
                <div className='w-full flex flex-col items-center p-3'>
                    <div className='border-2 p-1 rounded-full w-full flex justify-between m-3'>
                        <input type="text" placeholder='search userName' className='flex flex-1 border-0 outline-none ml-3' />
                        <button className='bg-main-green py-2 px-4 rounded-full text-white hover:bg-green-500' onClick={handleGetAllEmployees}>search</button>
                    </div>
